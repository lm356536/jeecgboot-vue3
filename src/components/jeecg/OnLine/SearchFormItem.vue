<template>
  <a-form-item
    v-if="item.view === DateTypeEnum.Date"
    :labelCol="labelCol"
  ...
  <a-form-item
    v-else-if="item.view === DateTypeEnum.Datetime"
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
  ...
  <a-form-item
    v-else-if="item.view === DateTypeEnum.Time"
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
    <template #label>
  ...
  <a-form-item
    v-else-if="
      item.view === CompTypeEnum.List ||
      item.view === CompTypeEnum.Radio ||
      item.view === CompTypeEnum.Switch
    "
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
  ...
  <a-form-item
    v-else-if="item.view === CompTypeEnum.SelTree"
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
    <template #label>
  ...
  <a-form-item
    v-else-if="item.view === CompTypeEnum.CatTree"
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
    <template #label>
  ...
  <a-form-item
    v-else-if="item.view === CompTypeEnum.SelSearch"
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
    <template #label>
  ...
  <a-form-item
    v-else-if="item.view === CompTypeEnum.SelUser"
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
    <template #label>
  ...
  <a-form-item
    v-else-if="item.view == CompTypeEnum.SelDepart"
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
    <template #label>
  ...
  <a-form-item
    v-else-if="item.view === CompTypeEnum.Popup"
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
    <template #label>
  ...
  <a-form-item
    v-else-if="item.view === CompTypeEnum.Pca"
    :labelCol="labelCol"
    :class="'jeecg-online-search'"
  >
    <template #label>
