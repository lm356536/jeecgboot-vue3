        ...
        <a-col :lg="8">
          <a-form-item label="订单日期">
            <a-date-picker
              ...
              v-model:value="orderMainModel.orderDate"
            />
          </a-form-item>
        </a-col>
      </a-row>
          ...
          <a-row class="form-row" :gutter="16">
            <a-col :lg="8">
              <a-form-item label="客户姓名">
                <a-input
                  v-model:value="orderMainModel.jeecgOrderCustomerList.name"
                  placeholder="请输入客户姓名"
                />
              </a-form-item>
            </a-col>
            <a-col :lg="8">
              <a-form-item label="手机号">
                <a-input
                  v-model:value="orderMainModel.jeecgOrderCustomerList.telphone"
                  placeholder="请输入手机号"
                />
              </a-form-item>
            </a-col>
          ...
          <a-row class="form-row" :gutter="16">
            <a-col :lg="8">
              <a-form-item label="航班号">
                <a-input
                  v-model:value="orderMainModel.jeecgOrderTicketList.ticketCode"
                  placeholder="请输入航班号"
                />
              </a-form-item>
            </a-col>
            ...
            try {
              ...
              orderMainModel.jeecgOrderCustomerList =
                Object.keys(orderMainModel.jeecgOrderCustomerList).length > 0
                  ...
                  : [];
              orderMainModel.jeecgOrderTicketList =
                Object.keys(orderMainModel.jeecgOrderTicketList).length > 0
                  ? [orderMainModel.jeecgOrderTicketList]
                  : [];
