<template>
  ...
  <a-modal
    title="请输入密码"
    v-model:visible="thirdPasswordShow"
    @ok="thirdLoginCheckPassword"
    @cancel="thirdLoginNoPassword"
  >
    <a-input-password
      placeholder="请输入密码"
      v-model:value="thirdLoginPassword"
  ...
  <a-modal
    :footer="null"
    :closable="false"
    v-model:visible="thirdConfirmShow"
  ...
  >
    <div class="ant-modal-confirm-body-wrapper">
      ...
      <div class="ant-modal-confirm-btns">
        <a-button @click="thirdLoginUserCreate" :loading="thirdCreateUserLoding"
          >创建新账号</a-button
        >
